...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelector('.btn-text').addEventListener('click', function(){
            ...
            if(input.value == '41'){
                input.style.border = '2px solid #07a014c7';
            input.style.backgroundColor = '#07a0142c';
            ...
            document.querySelector('.li3').style.color = 'green';
                ...
                input.style.border = '2px solid #c00606f6';
                input.style.backgroundColor = '#92201c49';
                ...
                document.querySelector('.li3').style.color = 'red';
                        ...
                        let solution4 = document.querySelector('#check4');
                         solution4.addEventListener('click', function (event) {
                             document.querySelector('.feedback6').style.color = 'white';
                         });

                         document.querySelector('.btn-text1').addEventListener('click', function(){
                            let input = document.querySelector('.input');
                            if(input.value == '5'){
                                input.style.border = '2px solid #07a014c7';
                            input.style.backgroundColor = '#07a0142c';
                            ...
                            document.querySelector('.li4').style.color = 'green';
                                ...
                                document.querySelector('.li4').style.color = 'red';
                                        ...
                                        let solution3 = document.querySelector('#check5');
